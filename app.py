...
class ResumeApp:
    ...
    def add_footer(self):
        ...
        with col2:
            ...
            <div style='display: flex; justify-content: center; align-items: center; margin-bottom: 10px;'>
                <a href='https://github.com/architaa1/AI-Resume-Maker_and_Analyzer' target='_blank' style='text-decoration: none;'>
            ...
            <p style='text-align: center;'>
                ...
                <a href="https://www.linkedin.com/in/archita-sinha-77161925a/" target="_blank" style='text-decoration: none; color: #FFFFFF'>
                    <b>Archita Sinha </b>
                </a>
            </p>
    ...
    def render_dashboard(self):
        ...
        st.toast("Check out these repositories: [Personal Portfolio](https://github.com/architaa1/My_Portfolio)", icon="ℹ️")
    ...
    f"Warning: Failed to save to database: {str(db_error)}")
        ...
        st.toast("Check out these repositories: [Electicity Demand Predictor](https://github.com/architaa1/AI-Model-Predicting-Electricity-Demand-in-Delhi)", icon="ℹ️")
    ...
    "Upload your resume", type=[
        ...
        st.toast("Check out these repositories: [Doctors_Appointment_Websit](https://github.com/architaa1/architaa1-Doctors_Appointment_Website)", icon="ℹ️")
    ...
    def render_home(self):
        ...
        st.toast("Check out these repositories: [AI-Agent-for-Financial-Literacy](https://github.com/architaa1/AI-Agent-for-Financial-Literacy)", icon="ℹ️")
...
<div style="background-color: #1e1e1e; border-radius: 10px; border: 1px solid #4b6cb7; padding: 10px; margin: 10px 0; color: white;">
    ...
    <ul style="margin-top: 0; padding-left: 20px;">
        <li><a href="https://github.com/architaa1/My_Portfolio" target="_blank" style="color: #4CAF50;">Archita Sinha Portfolio</a></li>
    </ul>
    <ul style="margin-top: 0; padding-left: 20px;">
        <li><a href="https://github.com/architaa1/architaa1-Doctors_Appointment_Website" target="_blank" style="color: #4CAF50;">Doctor's Apoointment Website</a></li>
    </ul>
    <ul style="margin-top: 0; padding-left: 20px;">
        <li><a href="https://github.com/architaa1/AI-Agent-for-Financial-Literacy" target="_blank" style="color: #4CAF50;">AI Agent for Financial Literacy</a></li>
    </ul>
    <ul style="margin-top: 0; padding-left: 20px;">
        <li><a href="https://github.com/architaa1/AI-Model-Predicting-Electricity-Demand-in-Delhi" target="_blank" style="color: #4CAF50;">Electricity Demand Prediction AI</a></li>
    </ul>
